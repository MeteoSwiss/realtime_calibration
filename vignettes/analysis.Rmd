...
Model variant 2 has the same setup as the final version except:
...
Model variant 6 had the same setup as the final version, but the changes to the tuning factor were
