...
# This is a wrapper of the nparcomp function to handle large data-frames containing integers
# See this: https://stackoverflow.com/questions/24047659/dataset-limitation-in-r-package-nparcomp
nparcomp_adjusted <- function (formula, data, type = c("Tukey", "Dunnett", "Sequen", 
